...
class Report(models.Model):
    reportuser = models.ForeignKey(User, on_delete = models.CASCADE, related_name = 'userreportwork')
    gigproposal = models.ForeignKey(GigProposal, on_delete = models.CASCADE, related_name = 'gig_Proposalworkreport', null = True)
    jobproposal = models.ForeignKey(JobRequirement, on_delete = models.CASCADE, related_name = 'job_workreportworkreport', null = True)
    reporteduser = models.ForeignKey(User, on_delete = models.CASCADE, related_name = 'userreportedworkreport')
